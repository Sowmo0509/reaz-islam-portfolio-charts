...
export const Logo = React.forwardRef<SVGElement, React.SVGAttributes<SVGElement>>((props, ref) => {
  return (
    <svg width="1em" height="1em" viewBox="0 0 324 323" fill="currentColor" xmlns="http://www.w3.org/2000/svg" ref={ref} {...props}>
